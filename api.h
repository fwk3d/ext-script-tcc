...
API extern int (*tcc_relocate)(TCCState *s1); // do all relocations (needed before using tcc_get_symbol())
...
int (*tcc_relocate)(TCCState *s1); // do all relocations (needed before using tcc_get_symbol())
